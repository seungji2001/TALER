package com.clone.practice.adapter
...
import com.clone.practice.EnrollBookActivity
import com.clone.practice.R
import com.clone.practice.TalerMain
...
*/
    ...
    private fun setChecked(book: Book,view: View){
        if(!book.checked){
            book.checked = true
            view.setBackgroundResource(R.drawable.square_background_border_red)

        }else{
            book.checked = false
            view.setBackgroundResource(R.drawable.square_background_border_black)
